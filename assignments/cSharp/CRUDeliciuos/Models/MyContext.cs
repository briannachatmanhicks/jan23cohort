...
{   
    ...
    //HINT: if you accidentally royally screw up your data base, you can delete the migrations folder and drop the schema from the mySQL workbench and then you can have a fresh database ready.
}